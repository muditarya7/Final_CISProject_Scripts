...
Original file is located at
    https://colab.research.google.com/drive/1QqbQ8-R7__BU56ZFqvy1pW_5n4UVsFgw
"""
...
zip_file_path = '/content/probe_EMISPEECH_DATA_AUDIO.zip'  # Replace with your path to the zip file
extraction_path = '/content/PROBE_EMISPEECH_DATA_AUDIO'  # Replace with your desired extraction path
...
data_dir = '/content/PROBE_EMISPEECH_DATA_AUDIO/probe_EMISPEECH_DATA_AUDIO'
    ...
    if file_name.endswith('.pkl'):
        ...
        with open(file_path, 'rb') as file:
            ...
            for feature_tensor, label_tuple in data_list:
                ...
                all_features.append(feature_tensor.numpy())
                all_labels.append(label_tuple[0].item())

all_features_np = np.stack(all_features)
